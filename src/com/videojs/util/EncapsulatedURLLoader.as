package com.videojs.util {
	...
	public class EncapsulatedURLLoader {
        ...
        public function EncapsulatedURLLoader(source: String, callback: Function) {
            _callback = callback;
		...
		private function parseAdSource(source:String): void {
			//ExternalInterface.call("console.log", source)
			var xmlData:XML = null;
			var creativeData:String = source;
			if (creativeData != null) {
				//ExternalInterface.call("console.log", "parsing")
				try {
